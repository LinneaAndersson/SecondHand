...
public class MainMenuScene extends GameMenuScene {
	...
	public void loadScene() {
		...
		menuItems.add(new MenuItem(MENU_NEW_GAME, LocalizationStrings
				.getInstance().getLocalizedString("menu_new_game")));
		menuItems.add(new MenuItem(MENU_HIGH_SCORE, LocalizationStrings
				.getInstance().getLocalizedString("menu_high_score")));
		menuItems.add(new MenuItem(MENU_OPTION, LocalizationStrings
				.getInstance().getLocalizedString("menu_options")));
		menuItems.add(new MenuItem(MENU_INSTRUCTION, LocalizationStrings
	...
	public AllScenes getParentScene() {
		// see the getParentScene method of LoadingScene for a motivation of why
