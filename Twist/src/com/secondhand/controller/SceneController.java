...
class SceneController {
	...
	public void switchScene(final AllScenes scene) {
		...
		if (scene == AllScenes.LOADING_SCENE) {
			new LoadingSceneController(this.sceneManager.getLoadingScene(),
					this, AllScenes.MAIN_MENU_SCENE);
		} else if (scene == AllScenes.LEVEL_LOADING_SCENE) {
			new LoadingSceneController(this.sceneManager.getLoadingScene(),
					this, AllScenes.GAME_PLAY_SCENE);
		} else if (scene == AllScenes.MAIN_MENU_SCENE) {
			new MainMenuSceneController(this.sceneManager.getMainMenuScene(),
					this);
		} else if (scene == AllScenes.HIGH_SCORE_SCENE) {
			new HighScoreSceneController(this.sceneManager.getHighScoreScene(),
					this);
	...
	public boolean sendOnKeyDownToCurrentScene(final int pKeyCode,
		...
		if (pKeyCode == KeyEvent.KEYCODE_BACK
			...
			if (this.sceneManager.getCurrentScene().getParentScene() != null) {
				...
				this.switchScene(this.sceneManager.getCurrentScene()
						.getParentScene());
