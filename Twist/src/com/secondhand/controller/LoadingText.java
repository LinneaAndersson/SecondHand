...
public class LoadingText extends ChangeableText {
	...
	// how many seconds to wait before showing the next string in the "animation"
	...
	public LoadingText(Camera camera) {
		super(0, 0, GlobalResources.getInstance().menuItemFont, 
				// TODO: ugly hack, fix(this string has to be longer than the presented string for some reason)
				"frferffreferloading");
	...
	private String getNextString() {
		if(loadingStrings == null) {
			...
			String loadingString = LocalizationStrings.getInstance().getLocalizedString("loading");
			loadingStrings = new String[]{
					loadingString + ".",
					loadingString + "..",
					loadingString + "..."
			};
