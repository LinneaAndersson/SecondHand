...
public final class ScoreLivesText extends ChangeableText {
	...
	public static String constructString(final String score,
			final String lives, final String completion) {

		// cache them
		if (scoreString == null || livesString == null) {
			scoreString = LocalizationStrings.getInstance().getLocalizedString(
					"score_string");
			livesString = LocalizationStrings.getInstance().getLocalizedString(
					"lives_string");
			completionString = LocalizationStrings.getInstance()
					.getLocalizedString("completion_string");
		}
	...
	public static String constructString(final int score, final int lives,
			final float completionRatio) {

		return constructString(score + "", lives + "",
				((int) (100 * completionRatio)) + "%");
	}
	...
	public ScoreLivesText(final Vector2 position, final int score,
			final int lives, final float completionRatio) {
